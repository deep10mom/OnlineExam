		...
		<div class="w3_agile_banner_top">
			<div class="agile_phone_mail">
				...
				<ul>
					...
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="#">Keshrideepa10@gmail.com.com</a></li>
				</ul>
		...
		<div class="agileits_w3layouts_banner_nav">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.html"><i>ON</i><span>LineExam</span></a></h1>
				</div>
				<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item"><a href="front.jsp" class="menu__link">Home</a></li>
